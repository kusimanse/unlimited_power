...
if args['mulligan']:
	...
	for i in range(num_runs):
	    bot = SimpleBot(args['decklist'], draw_method='mulligan', target = args['heuristic'])
...
if args['second']:
	runs = []
	for i in range(num_runs):
	    bot = SimpleBot(args['decklist'], draw_method='second', target = args['heuristic'])
	    [bot.play_turn() for x in range(turns_per_run)]
	    power_per_turn = bot.power_drawn_per_turn
	    if len(runs) == 0:
	        runs = [[x] for x in power_per_turn]
...
if args['initial']:
	runs = []
	for i in range(num_runs):
	    bot = SimpleBot(args['decklist'], draw_method='initial', target = args['heuristic'])
	    [bot.play_turn() for x in range(turns_per_run)]
	    power_per_turn = bot.power_drawn_per_turn
	    if len(runs) == 0:
	        runs = [[x] for x in power_per_turn]
...
if args['seven']:
	runs = []
	for i in range(num_runs):
	    bot = SimpleBot(args['decklist'], draw_method='seven', target = args['heuristic'])
	    [bot.play_turn() for x in range(turns_per_run)]
	    power_per_turn = bot.power_drawn_per_turn
	    if len(runs) == 0:
	        runs = [[x] for x in power_per_turn]
